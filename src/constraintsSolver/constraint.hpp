...
public:
	static std::shared_ptr<pointPoint_horizontality> make(sketchPoint_ptr p1, sketchPoint_ptr p2)
	{
		...
		std::shared_ptr<constraintAnnotation> annot1(new constraintAnnotation(glm::vec2(0.0, 0.0), p1->basePlane(), "resources/textures/images/icons/icon.png"));
		std::shared_ptr<constraintAnnotation> annot2(new constraintAnnotation(glm::vec2(0.0, 0.0), p1->basePlane(), "resources/textures/images/icons/icon.png"));
	...
	static std::shared_ptr<pointPoint_horizontality> make(sketchLine_ptr l)
	{
		...
		auto annot = std::make_shared<constraintAnnotation>(glm::vec2(0.0, 0.0), l->basePlane(), "resources/textures/images/icons/icon.png");
...
public:
	static std::shared_ptr<pointPoint_distance> make(sketchPoint_ptr p1, sketchPoint_ptr p2, expression_ptr d)
	{
		...
		auto annot1 = std::make_shared<constraintAnnotation>(glm::vec2(0.0, 0.0), p1->basePlane(), "resources/textures/images/icons/icon.png");
		auto annot2 = std::make_shared<constraintAnnotation>(glm::vec2(0.0, 0.0), p1->basePlane(), "resources/textures/images/icons/icon.png");
		p1->add_constraintAnnotation(annot1);
		p2->add_constraintAnnotation(annot2);
		return constr;
	}
...
public:
	...
	static std::shared_ptr<lineLine_angle> make_parallel(sketchLine_ptr l1, sketchLine_ptr l2)
	{
		...
		auto annot1 = std::make_shared<constraintAnnotation>(glm::vec2(0.0, 0.0), l1->basePlane(), "resources/textures/images/icons/icon.png");
		auto annot2 = std::make_shared<constraintAnnotation>(glm::vec2(0.0, 0.0), l1->basePlane(), "resources/textures/images/icons/icon.png");
