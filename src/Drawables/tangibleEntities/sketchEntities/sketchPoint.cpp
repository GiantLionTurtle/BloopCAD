...
sketchPoint::sketchPoint(glm::vec2 pos_2d, Geom3d::plane_abstr* basePlane_, bool immovable/* = false*/):
...
sketchPoint::sketchPoint(var_ptr x_, var_ptr y_, Geom3d::plane_abstr* basePlane_, bool immovable/* = false*/):
	sketchGeometry(basePlane_, types::POINT),
	mX(x_),
	mY(y_)
{
