...
// template<class Impl>
// glm::dvec2 Circle_abstr<Impl>::center_pos()
// {
// 	return static_cast<Impl*>(this)->center_pos_impl();
// }
// template<class Impl>
// double Circle_abstr<Impl>::radius_val()
// {
// 	return static_cast<Impl*>(this)->radius_val_impl();
// }

// template<class Impl>
// glm::dvec2 Circle_abstr<Impl>::at_geom(double t)
// {
// 	double angle = t * (M_PI * 2.0f);
// 	return center_pos() + glm::dvec2(std::cos(angle), std::sin(angle)) * (double)radius_val();
// }
// template<class Impl>
// bool Circle_abstr<Impl>::within_geom(glm::dvec2 top_left, glm::dvec2 bottom_right, bool contained)
// {
// 	if(contained) {
...
// }
// template<class Impl>
// double Circle_abstr<Impl>::closest_to_point_interp_geom(glm::dvec2 const& pt)
// {
...
// }
// template<class Impl>
// glm::dvec2 Circle_abstr<Impl>::closest_to_point_geom(glm::dvec2 const& pt)
// {
// 	glm::dvec2 center_to_point = glm::normalize(pt - center_pos());
// 	return center_pos() + center_to_point * (double)radius_val();  
// }
// template<class Impl>
// double Circle_abstr<Impl>::dist_to_point_geom(glm::dvec2 const& pt)
// {
...
// Circle::Circle(glm::dvec2 c, double r)
// 	: mCenter(c)
// 	, mRadius(r)
// {
